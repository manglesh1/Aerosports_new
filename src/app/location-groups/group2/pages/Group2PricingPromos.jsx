...
import { generateSchema, fetchPricingTableData, fetchPageData, fetchsheetdata } from "@g2/lib/sheets";

const Group2PricingPromos = async ({ params }) => {
...
export default Group2PricingPromos;
