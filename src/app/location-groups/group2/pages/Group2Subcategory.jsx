...
import SubCategoryCard from "@g2/components/smallComponents/SubCategoryCard";
import FaqCard from "@g2/components/smallComponents/FaqCard";
import {
  fetchsheetdata,
  fetchMenuData,
  getWaiverLink,
...
const Group2Subcategory = async ({ params }) => {
...
export default Group2Subcategory;
