...
// Group2 (oakville/london/scarborough) reads its OWN workbook — the former
// oakville-group / rajan sheet — independent of the main app's SHEET_URL.
const SHEET_URL = process.env.GROUP2_SHEET_URL
  || 'https://docs.google.com/spreadsheets/d/1phEZ3UKnCZzR30RqbD9LyLTdPsGxIEO2k-xhtV5mPhw/export?format=xlsx';
