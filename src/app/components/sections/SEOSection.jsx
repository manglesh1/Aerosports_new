	...
	return (
		<section className="v11_bp_intro_section" style={{ paddingTop: "4rem", paddingBottom: "4rem" }}>
			<div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
				...
				<div
					className="flex flex-col gap-4 [&_h1]:text-[clamp(2rem,5vw,3rem)] [&_h1]:font-black [&_h1]:uppercase [&_h1]:leading-[1.15] [&_h1]:text-[#0f172a] [&_h2]:text-[clamp(1.5rem,4vw,2.2rem)] [&_h2]:font-black [&_h2]:uppercase [&_h2]:leading-[1.15] [&_h2]:text-[#0f172a] [&_p]:text-[#475569] [&_p]:leading-[1.8] [&_p]:text-base [&_strong]:text-[#B7E600] [&_strong]:font-bold"
				...
				<div>
					<div className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.08)] border border-[#e2e8f0]">
						...
						<div className="px-6 pb-6">
							<p className="text-base font-bold text-[#B7E600] mb-1">
