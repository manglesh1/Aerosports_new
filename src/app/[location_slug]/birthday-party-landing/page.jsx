...
export default async function BirthdayAdLandingPage({ params }) {
  ...
  const [pageData, locationData, menuData, birthdayRows, birthdayJson] = await Promise.all([
    ...
    <main className={`birthday_ad_page ${robotoCondensed.variable}`}>
      <section className="birthday_ad_hero" id="top">
        ...
        <div className="birthday_ad_hero_inner">
          <div className="birthday_ad_hero_copy">
            ...
            <p>
              Active indoor birthday parties with trampolines, challenge zones, party rooms, and a team that keeps the day moving.
            </p>
            <div className="birthday_ad_actions">
              <a href="#packages" className="birthday_ad_primary">View party packages</a>
              <Link
                href={bookingUrl}
                className="birthday_ad_secondary"
            ...
            <div className="birthday_ad_stats">
              <span><strong>20+</strong> attractions</span>
      ...
      <section className="birthday_ad_packages" id="packages">
        <div className="birthday_ad_section_head">
          ...
          <p>Compare the options, then send a request or book directly with the park.</p>
        </div>
      ...
      <section className="birthday_ad_private">
        ...
        <div className="birthday_ad_private_actions">
          ...
          <Link href={bookingUrl} target={isExternalBooking ? "_blank" : undefined} rel={isExternalBooking ? "noopener noreferrer" : undefined}>
            Inquire now
          </Link>
        </div>
      </section>
      ...
      <section className="birthday_ad_highlights" id="highlights">
        <div className="birthday_ad_section_head birthday_ad_section_head_left">
          ...
          <h2>Everything kids love, without the boring party room wait.</h2>
        </div>
      ...
      <section className="birthday_ad_games" id="games">
        <div className="birthday_ad_section_head">
          ...
          <h2>Every part of the park brings a new challenge.</h2>
        </div>
      ...
      <section className="birthday_ad_final">
        <h2>Ready to give them a birthday they will talk about all week?</h2>
        <div>
          <Link
            href={bookingUrl}
