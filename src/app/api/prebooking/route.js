      ...
      <html>
        <head>
          <style>
            ...
            .header {
              background: linear-gradient(135deg, #B7E600 0%, #ff2d87 100%);
              color: white;
              padding: 30px;
              text-align: center;
          ...
          <div class="content">
            ...
            <div class="info-section">
              ...
              <div class="info-value">
                <a href="mailto:${email}" style="color: #B7E600; text-decoration: none;">${email}</a>
              </div>
            </div>
            ...
            <div class="info-section">
              ...
              <div class="info-value">
                <a href="tel:${phone}" style="color: #B7E600; text-decoration: none;">${phone}</a>
              </div>
            </div>
        ...
        <body>
          ...
          <div class="content">
            ...
            <div class="highlight-box">
              <h3 style="margin-top: 0; color: #B7E600;">What's Next?</h3>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <p style="font-size: 18px; color: #B7E600; font-weight: bold;">Get Ready for the Ultimate Entertainment Experience!</p>
            </div>
