...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[727], { 67: (e) => {
      ...
      r.r(b), r.d(b, { config: () => eH, middleware: () => eG });
      let v = null;
      function w() {
        return v || (v = m()), v;
      }
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let eB = /* @__PURE__ */ new Set(["windsor", "st-catharines"]), eU = /* @__PURE__ */ new Set(["brampton", "thunderbay"]), eq = /* @__PURE__ */ new Set(["oakville", "london", "scarborough"]), e$ = process.env.GROUP3_ORIGIN;
      function eG(e2) {
        let t2 = e2.nextUrl.clone(), r2 = e2.headers.get("host") || "";
        if (!(r2.startsWith("localhost") || r2.startsWith("127.0.0.1"))) {
          if ("https" !== (e2.headers.get("x-forwarded-proto") || "http")) return Y.redirect(`https://${r2}${t2.pathname}${t2.search}`, 308);
          if ("aerosportsparks.ca" === r2) return Y.redirect(`https://www.aerosportsparks.ca${t2.pathname}${t2.search}`, 308);
        }
        let n2 = t2.pathname.split("/").filter(Boolean);
        if (n2.length >= 1) {
          let e3 = n2[0].toLowerCase();
          if (eU.has(e3)) return Y.next();
          if (eB.has(e3) && 2 === n2.length && ["contactus", "contact-us"].includes(n2[1].toLowerCase())) return t2.pathname = `/${e3}/about-us/contact-us`, Y.redirect(t2, 308);
          if (e$ && eq.has(e3)) return Y.rewrite(new URL(`${t2.pathname}${t2.search}`, e$));
          if (!["admin", "studio", "api", "_next", "assets", "invitations", "favicon.ico", "sitemap.xml", "robots.txt", "test", "llms.txt", "about-us", "contact-us", "privacy-policy", "attractions", "school-groups", "summer-camps", "team-celebrations", "corporate-events", "blogs", "audits"].includes(e3) && !eB.has(e3)) return new Y(`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    ...
    <main>
...
</html>`, { status: 404, headers: { "Content-Type": "text/html; charset=utf-8", "X-Robots-Tag": "noindex, nofollow" } });
        }
        return Y.next();
      }
      let eH = { matcher: ["/((?!api|_next/static|_next/image|favicon.ico).*)", "/admin/:path*", "/locations/:path*", "/"] }, eF = { ...b }, ez = eF.middleware || eF.default, eW = "/src/middleware";
      ...
      (() => {
        var i = { 226: function(i2, a2) {
          !function(o2, s2) {
            "use strict";
            var l = "function", u = "undefined", d = "object", c = "string", p = "major", g = "model", h = "name", f = "type", b = "vendor", m = "version", v = "architecture", w = "console", y = "mobile", _ = "tablet", x = "smarttv", S = "wearable", P = "embedded", O = "Amazon", R = "Apple", N = "ASUS", C = "BlackBerry", T = "Browser", E = "Chrome", M = "Firefox", I = "Google", A = "Huawei", L = "Microsoft", k = "Motorola", j = "Opera", D = "Samsung", V = "Sharp", B = "Sony", U = "Xiaomi", q = "Zebra", $ = "Facebook", G = "Chromium OS", H = "Mac OS", F = function(e2, t2) {
              var r2 = {};
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico).*))(.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/locations(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(\\/?index|\\/?index\\.json))?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": { "NEXT_PUBLIC_API_URL": "https://apis-351216.nn.r.appspot.com/api", "NEXT_PUBLIC_BASE_URL": "https://www.aerosportsparks.ca", "SHEET_URL": "https://docs.google.com/spreadsheets/d/1B_9EaTQDztWGH_cD3lUP7hpWD6FvNBJ-6Czml2x7d9c/export?format=xlsx" }, "webpack": null, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.mjs", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "analyticsId": "", "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "inline", "remotePatterns": [], "unoptimized": true }, "devIndicators": { "buildActivity": true, "buildActivityPosition": "bottom-right" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "optimizeFonts": true, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "httpAgentOptions": { "keepAlive": true }, "outputFileTracing": true, "staticPageGenerationTimeout": 60, "swcMinify": true, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "experimental": { "multiZoneDraftMode": false, "prerenderEarlyExit": false, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 1, "memoryBasedWorkersCount": false, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "outputFileTracingRoot": "C:\\code\\Aerosports_new - Copy - Copy", "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "adjustFontFallbacks": false, "adjustFontFallbacksWithSizeAdjust": false, "typedRoutes": false, "instrumentationHook": false, "bundlePagesExternals": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "missingSuspenseWithCSRBailout": true, "optimizeServerReact": true, "useEarlyImport": false, "staleTimes": { "dynamic": 30, "static": 300 }, "optimizePackageImports": ["react-bootstrap", "react-icons", "date-fns", "xlsx", "react-quill", "lucide-react", "lodash-es", "ramda", "antd", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "configFileName": "next.config.mjs", "compiler": { "removeConsole": { "exclude": ["error", "warn"] } }, "_originalRedirects": [{ "source": "/brampton", "destination": "/oakville", "permanent": true }, { "source": "/brampton/:slug*", "destination": "/oakville", "permanent": true }, { "source": "/oakville/programs/summerpass", "destination": "/oakville/programs/camps", "permanent": true }, { "source": "/:city/programs/summer-camps-2024", "destination": "/:city/programs/camps", "permanent": true }, { "source": "/oakville/birthday-parties", "destination": "/oakville/kids-birthday-parties", "permanent": true }, { "source": "/:path*/about-us/:slug/:mulug", "destination": "/:path*/about-us", "permanent": true }, { "source": "/:path*/aboutus", "destination": "/:path*/about-us", "permanent": true }, { "source": "/:path*/home/", "destination": "/:path*/", "permanent": true }, { "source": "/:path*/aboutus/:slug*", "destination": "/:path*/about-us/:slug*", "permanent": true }, { "source": "/st-catharines/attractions/open-jumps", "destination": "/st-catharines/attractions/open-jump", "permanent": true }, { "source": "/:path*/brampton", "destination": "/oakville", "permanent": true }, { "source": "/:path*/contact us", "destination": "/:path*/contact-us", "permanent": true }, { "source": "/thunderbay/:path*", "destination": "/oakville", "permanent": true }, { "source": "/st-catharines/glow", "destination": "/st-catharines/programs/glow", "permanent": true }, { "source": "/london/summerpass", "destination": "/london/programs/camps", "permanent": true }, { "source": "/:path*/st-catharines/group-bookings", "destination": "/:path*/st-catharines/groups-events", "permanent": true }, { "source": "/st-catharines/home", "destination": "/st-catharines", "permanent": true }, { "source": "/oakville/home", "destination": "/oakville", "permanent": true }, { "source": "/london/home", "destination": "/london", "permanent": true }, { "source": "/windsor/home", "destination": "/windsor", "permanent": true }, { "source": "/scarborough/home", "destination": "/scarborough", "permanent": true }, { "source": "/:path*/group-events", "destination": "/:path*/groups-events", "permanent": true }, { "source": "/:path*/group-bookings", "destination": "/:path*/groups-events", "permanent": true }, { "source": "/:path/contact-us", "destination": "/:path/about-us/contact-us", "permanent": true }, { "source": "/:path/open-jumps", "destination": "/:path/attractions/open-jump", "permanent": true }, { "source": "/london/attractions/warpedwalls", "destination": "/london/attractions/warped-walls", "permanent": true }, { "source": "/:path*/contactus", "destination": "/:path*/about-us/contact-us", "permanent": true }, { "source": "/:path*/trampoline-park-safety-and-rules", "destination": "/:path*/about-us/safety-information", "permanent": true }, { "source": "/:path*/blog-details/:splat0*", "destination": "/:path*/blogs/:splat0*", "permanent": true }] };
var BuildId = "I5oZBszw1DvDSpep6RxwP";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }, { "source": "/brampton", "destination": "/oakville", "statusCode": 308, "regex": "^(?!/_next)/brampton(?:/)?$" }, { "source": "/brampton/:slug*", "destination": "/oakville", "statusCode": 308, "regex": "^(?!/_next)/brampton(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/oakville/programs/summerpass", "destination": "/oakville/programs/camps", "statusCode": 308, "regex": "^(?!/_next)/oakville/programs/summerpass(?:/)?$" }, { "source": "/:city/programs/summer-camps-2024", "destination": "/:city/programs/camps", "statusCode": 308, "regex": "^(?!/_next)(?:/([^/]+?))/programs/summer-camps-2024(?:/)?$" }, { "source": "/oakville/birthday-parties", "destination": "/oakville/kids-birthday-parties", "statusCode": 308, "regex": "^(?!/_next)/oakville/birthday-parties(?:/)?$" }, { "source": "/:path*/about-us/:slug/:mulug", "destination": "/:path*/about-us", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/about-us(?:/([^/]+?))(?:/([^/]+?))(?:/)?$" }, { "source": "/:path*/aboutus", "destination": "/:path*/about-us", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/aboutus(?:/)?$" }, { "source": "/:path*/home/", "destination": "/:path*/", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/home/(?:/)?$" }, { "source": "/:path*/aboutus/:slug*", "destination": "/:path*/about-us/:slug*", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/aboutus(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/st-catharines/attractions/open-jumps", "destination": "/st-catharines/attractions/open-jump", "statusCode": 308, "regex": "^(?!/_next)/st-catharines/attractions/open-jumps(?:/)?$" }, { "source": "/:path*/brampton", "destination": "/oakville", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/brampton(?:/)?$" }, { "source": "/:path*/contact us", "destination": "/:path*/contact-us", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/contact us(?:/)?$" }, { "source": "/thunderbay/:path*", "destination": "/oakville", "statusCode": 308, "regex": "^(?!/_next)/thunderbay(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/st-catharines/glow", "destination": "/st-catharines/programs/glow", "statusCode": 308, "regex": "^(?!/_next)/st-catharines/glow(?:/)?$" }, { "source": "/london/summerpass", "destination": "/london/programs/camps", "statusCode": 308, "regex": "^(?!/_next)/london/summerpass(?:/)?$" }, { "source": "/:path*/st-catharines/group-bookings", "destination": "/:path*/st-catharines/groups-events", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/st-catharines/group-bookings(?:/)?$" }, { "source": "/st-catharines/home", "destination": "/st-catharines", "statusCode": 308, "regex": "^(?!/_next)/st-catharines/home(?:/)?$" }, { "source": "/oakville/home", "destination": "/oakville", "statusCode": 308, "regex": "^(?!/_next)/oakville/home(?:/)?$" }, { "source": "/london/home", "destination": "/london", "statusCode": 308, "regex": "^(?!/_next)/london/home(?:/)?$" }, { "source": "/windsor/home", "destination": "/windsor", "statusCode": 308, "regex": "^(?!/_next)/windsor/home(?:/)?$" }, { "source": "/scarborough/home", "destination": "/scarborough", "statusCode": 308, "regex": "^(?!/_next)/scarborough/home(?:/)?$" }, { "source": "/:path*/group-events", "destination": "/:path*/groups-events", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/group-events(?:/)?$" }, { "source": "/:path*/group-bookings", "destination": "/:path*/groups-events", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/group-bookings(?:/)?$" }, { "source": "/:path/contact-us", "destination": "/:path/about-us/contact-us", "statusCode": 308, "regex": "^(?!/_next)(?:/([^/]+?))/contact-us(?:/)?$" }, { "source": "/:path/open-jumps", "destination": "/:path/attractions/open-jump", "statusCode": 308, "regex": "^(?!/_next)(?:/([^/]+?))/open-jumps(?:/)?$" }, { "source": "/london/attractions/warpedwalls", "destination": "/london/attractions/warped-walls", "statusCode": 308, "regex": "^(?!/_next)/london/attractions/warpedwalls(?:/)?$" }, { "source": "/:path*/contactus", "destination": "/:path*/about-us/contact-us", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/contactus(?:/)?$" }, { "source": "/:path*/trampoline-park-safety-and-rules", "destination": "/:path*/about-us/safety-information", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/trampoline-park-safety-and-rules(?:/)?$" }, { "source": "/:path*/blog-details/:splat0*", "destination": "/:path*/blogs/:splat0*", "statusCode": 308, "regex": "^(?!/_next)(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?/blog-details(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/about-us", "regex": "^/about\\-us(?:/)?$", "routeKeys": {}, "namedRegex": "^/about\\-us(?:/)?$" }, { "page": "/attractions", "regex": "^/attractions(?:/)?$", "routeKeys": {}, "namedRegex": "^/attractions(?:/)?$" }, { "page": "/audits", "regex": "^/audits(?:/)?$", "routeKeys": {}, "namedRegex": "^/audits(?:/)?$" }, { "page": "/blogs", "regex": "^/blogs(?:/)?$", "routeKeys": {}, "namedRegex": "^/blogs(?:/)?$" }, { "page": "/contact-us", "regex": "^/contact\\-us(?:/)?$", "routeKeys": {}, "namedRegex": "^/contact\\-us(?:/)?$" }, { "page": "/corporate-events", "regex": "^/corporate\\-events(?:/)?$", "routeKeys": {}, "namedRegex": "^/corporate\\-events(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/privacy-policy", "regex": "^/privacy\\-policy(?:/)?$", "routeKeys": {}, "namedRegex": "^/privacy\\-policy(?:/)?$" }, { "page": "/school-groups", "regex": "^/school\\-groups(?:/)?$", "routeKeys": {}, "namedRegex": "^/school\\-groups(?:/)?$" }, { "page": "/sitemap.xml", "regex": "^/sitemap\\.xml(?:/)?$", "routeKeys": {}, "namedRegex": "^/sitemap\\.xml(?:/)?$" }, { "page": "/studio", "regex": "^/studio(?:/)?$", "routeKeys": {}, "namedRegex": "^/studio(?:/)?$" }, { "page": "/studio/login", "regex": "^/studio/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/studio/login(?:/)?$" }, { "page": "/summer-camps", "regex": "^/summer\\-camps(?:/)?$", "routeKeys": {}, "namedRegex": "^/summer\\-camps(?:/)?$" }, { "page": "/team-celebrations", "regex": "^/team\\-celebrations(?:/)?$", "routeKeys": {}, "namedRegex": "^/team\\-celebrations(?:/)?$" }, { "page": "/test", "regex": "^/test(?:/)?$", "routeKeys": {}, "namedRegex": "^/test(?:/)?$" }], "dynamic": [{ "page": "/blogs/[slug]", "regex": "^/blogs/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/blogs/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/studio/[tab]", "regex": "^/studio/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtab": "nxtPtab" }, "namedRegex": "^/studio/(?<nxtPtab>[^/]+?)(?:/)?$" }, { "page": "/studio/[tab]/[row]", "regex": "^/studio/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtab": "nxtPtab", "nxtProw": "nxtProw" }, "namedRegex": "^/studio/(?<nxtPtab>[^/]+?)/(?<nxtProw>[^/]+?)(?:/)?$" }, { "page": "/[location_slug]", "regex": "^/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)(?:/)?$" }, { "page": "/[location_slug]/blogs", "regex": "^/([^/]+?)/blogs(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/blogs(?:/)?$" }, { "page": "/[location_slug]/blogs/[slug]", "regex": "^/([^/]+?)/blogs/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug", "nxtPslug": "nxtPslug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/blogs/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/[location_slug]/bogo", "regex": "^/([^/]+?)/bogo(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/bogo(?:/)?$" }, { "page": "/[location_slug]/camps", "regex": "^/([^/]+?)/camps(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/camps(?:/)?$" }, { "page": "/[location_slug]/contactus", "regex": "^/([^/]+?)/contactus(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/contactus(?:/)?$" }, { "page": "/[location_slug]/gallery", "regex": "^/([^/]+?)/gallery(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/gallery(?:/)?$" }, { "page": "/[location_slug]/kids-birthday-parties", "regex": "^/([^/]+?)/kids\\-birthday\\-parties(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/kids\\-birthday\\-parties(?:/)?$" }, { "page": "/[location_slug]/kids-birthday-parties/invitations", "regex": "^/([^/]+?)/kids\\-birthday\\-parties/invitations(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/kids\\-birthday\\-parties/invitations(?:/)?$" }, { "page": "/[location_slug]/membership", "regex": "^/([^/]+?)/membership(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/membership(?:/)?$" }, { "page": "/[location_slug]/pricing-promos", "regex": "^/([^/]+?)/pricing\\-promos(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/pricing\\-promos(?:/)?$" }, { "page": "/[location_slug]/[category_slug]", "regex": "^/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug", "nxtPcategory_slug": "nxtPcategory_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/(?<nxtPcategory_slug>[^/]+?)(?:/)?$" }, { "page": "/[location_slug]/[category_slug]/[subcategory_slug]", "regex": "^/([^/]+?)/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocation_slug": "nxtPlocation_slug", "nxtPcategory_slug": "nxtPcategory_slug", "nxtPsubcategory_slug": "nxtPsubcategory_slug" }, "namedRegex": "^/(?<nxtPlocation_slug>[^/]+?)/(?<nxtPcategory_slug>[^/]+?)/(?<nxtPsubcategory_slug>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [{ "source": "/admin/:path*", "headers": [{ "key": "X-Robots-Tag", "value": "noindex, nofollow, noarchive" }], "regex": "^/admin(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/api/:path*", "headers": [{ "key": "X-Robots-Tag", "value": "noindex, nofollow, noarchive" }], "regex": "^/api(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/:path*", "headers": [{ "key": "Cache-Control", "value": "public, max-age=0, s-maxage=600, stale-while-revalidate=21600" }], "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/_next/static/:path*", "headers": [{ "key": "Cache-Control", "value": "public, max-age=31536000, immutable" }], "regex": "^/_next/static(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }];
var PrerenderManifest = { "version": 4, "routes": { "/api/refresh": { "initialHeaders": { "content-type": "application/json", "x-next-cache-tags": "_N_T_/layout,_N_T_/api/layout,_N_T_/api/refresh/layout,_N_T_/api/refresh/route,_N_T_/api/refresh" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/api/refresh", "dataRoute": null }, "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null }, "/sitemap.xml": { "initialHeaders": { "content-type": "application/xml", "x-next-cache-tags": "_N_T_/layout,_N_T_/sitemap.xml/layout,_N_T_/sitemap.xml/route,_N_T_/sitemap.xml" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/sitemap.xml", "dataRoute": null } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "7140c4dc2c56e956686811810e29d920", "previewModeSigningKey": "e0ccddfbc85a4f6759a15a2310afe10f95204d6c8ae5811f5ac112aaa9ac2144", "previewModeEncryptionKey": "6ccc83b631dd3b28bf2c3fa4b65e2649bae24b339ba9030bc7707884b3c0db5b" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico).*))(.json)?[\\/#\\?]?$", "originalSource": "/((?!api|_next/static|_next/image|favicon.ico).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/locations(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$", "originalSource": "/locations/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(\\/?index|\\/?index\\.json))?[\\/#\\?]?$", "originalSource": "/" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "I5oZBszw1DvDSpep6RxwP", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "bqHKy8JHA/VW+9EKMiroQOaPmsdJFYZnAc8fHvCv6xw=", "__NEXT_PREVIEW_MODE_ID": "7140c4dc2c56e956686811810e29d920", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "6ccc83b631dd3b28bf2c3fa4b65e2649bae24b339ba9030bc7707884b3c0db5b", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "e0ccddfbc85a4f6759a15a2310afe10f95204d6c8ae5811f5ac112aaa9ac2144" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/about-us/page": "/about-us", "/api/attraction-details/route": "/api/attraction-details", "/api/prebooking/route": "/api/prebooking", "/api/refresh/route": "/api/refresh", "/api/studio/login/route": "/api/studio/login", "/attractions/page": "/attractions", "/blogs/[slug]/page": "/blogs/[slug]", "/contact-us/page": "/contact-us", "/corporate-events/page": "/corporate-events", "/favicon.ico/route": "/favicon.ico", "/api/studio/sheet/route": "/api/studio/sheet", "/page": "/", "/privacy-policy/page": "/privacy-policy", "/school-groups/page": "/school-groups", "/sitemap.xml/route": "/sitemap.xml", "/summer-camps/page": "/summer-camps", "/team-celebrations/page": "/team-celebrations", "/test/page": "/test", "/api/page-json/route": "/api/page-json", "/audits/page": "/audits", "/api/studio/upload/route": "/api/studio/upload", "/blogs/page": "/blogs", "/[location_slug]/[category_slug]/[subcategory_slug]/page": "/[location_slug]/[category_slug]/[subcategory_slug]", "/[location_slug]/blogs/page": "/[location_slug]/blogs", "/[location_slug]/blogs/[slug]/page": "/[location_slug]/blogs/[slug]", "/[location_slug]/[category_slug]/page": "/[location_slug]/[category_slug]", "/[location_slug]/bogo/page": "/[location_slug]/bogo", "/[location_slug]/camps/page": "/[location_slug]/camps", "/[location_slug]/contactus/page": "/[location_slug]/contactus", "/[location_slug]/gallery/page": "/[location_slug]/gallery", "/[location_slug]/kids-birthday-parties/invitations/page": "/[location_slug]/kids-birthday-parties/invitations", "/[location_slug]/membership/page": "/[location_slug]/membership", "/[location_slug]/page": "/[location_slug]", "/[location_slug]/kids-birthday-parties/page": "/[location_slug]/kids-birthday-parties", "/[location_slug]/pricing-promos/page": "/[location_slug]/pricing-promos", "/studio/login/page": "/studio/login", "/studio/[tab]/[row]/page": "/studio/[tab]/[row]", "/studio/page": "/studio", "/studio/[tab]/page": "/studio/[tab]" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/studio/upload": {}, "/api/page-json": {}, "/audits": {}, "/studio/[tab]/[row]": {}, "/studio": {}, "/studio/[tab]": {}, "/blogs": {} } };
